About r-goodpractice-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-goodpractice-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-goodpractice-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-goodpractice
# for installing globally
pixi global install r-goodpractice
```
...
It is possible to list all of the versions of `r-goodpractice` available on your platform:
...
```
pixi search r-goodpractice --channel conda-forge
```
